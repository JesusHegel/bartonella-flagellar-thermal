...
ddsY <- DESeq(ddsY, quiet=TRUE); saveRDS(ddsY, "salida/dds_lote.rds")
...
write.csv(ct(dds ,"Pl37","Pl25"), "salida/res_rG.csv")
write.csv(ct(ddsY,"Pl37","Pl25"), "salida/res_rY.csv")
write.csv(ct(ddsY,"Pl30","Pl25"), "salida/res_r30.csv")
write.csv(ct(ddsY,"Pl37","Pl30"), "salida/res_r3730.csv")
write.csv(ct(ddsY,"pH06","pH08"), "salida/res_rpH.csv")
cat("\nCinco contrastes escritos en salida/\n")
